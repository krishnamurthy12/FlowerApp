...
import com.krish.flowerapp.adapters.MyPagerAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    private void initializeViews() {
       ...
       /* userPic = headerView.findViewById(R.id.vI_nh_userpic);
        ...
        mTabLayout.addTab(mTabLayout.newTab().setText("Flowers"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Customers"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Vendors"));
